    ...
    <>
      <form>
        ...
        <div className="first mt-4 w-full md:w-[600px] lg:w-[800px]">
            ...
            <div className="first mt-4 w-full md:w-[600px] lg:w-[800px]">
              <label htmlFor="email" className='font-bold text-xl mb-4 text-red-950 ml-1'>Contact Number</label>
            ...
            <div className="div text-lg mt-8 text-black text-center">
                <p className='tracking-wide'>By submitting this form, you conset to our Terms of use & Privacy</p>
