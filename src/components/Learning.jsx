    ...
    <div>
      <div className="fifth mt-20 bg-red-950 h-auto w-full pb-16 px-16 text-center text-lg text-amber-500 flex items-center flex-col">
        ...
        <div className="text mt-9">
          <p className="hidden lg:block hover:scale-105 transition-transform duration-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit aliquid saepe asperiores dignissimos itaque consequatur beatae! Incidunt distentiu!</p>
          <p className="block sm:hidden hover:scale-105 transition-transform duration-300">Lorem ipsum dolor sit amet consectetur.</p>
          <p className="mt-2 hidden lg:block hover:scale-105 transition-transform duration-300">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          <p className="mt-2 block lg:hidden hover:scale-105 transition-transform duration-300">Lorem ipsum dolor sit amet.</p>
        </div>
        ...
        <div className='flex justify-evenly gap-10 flex-wrap'>
          {img.map((image, index) => (
            ...
            >
              <img src={image.img} className='sm:h-56 h-32 max-[700px]:h-20 max-[400px]:h-16 hover:scale-110 transition-transform duration-500' alt="" />
              <p>{image.about}</p>
              <p>{image.about2}</p>
              <p>{image.about3}</p>
            </div>
      ...
      <div className="btn mt-20 flex justify-evenly w-full items-center text-center h-56 rounded-2xl bg-amber-600 m-auto max-[800px]:flex-wrap">
        <div className="text text-lg text-red-950">
          <p className="text-4xl text-red-950 font-bold tracking-wider bg-gradient-to-r from-red-600 to-violet-600
        ...
        <div className='flex justify-center items-center gap-6 py-14 max-[650px]:py-4 bg-red-950 text-amber-600 h-16 w-60 sm:w-80 font-bold text-2xl rounded-2xl hover:bg-amber-700 hover:text-black border-2 border-black transition-all duration-300 ease-in-out'>
          ...
          />
          <button 
            className='flex justify-center items-center max-[650px]:text-lg text-3xl hover:underline hover:scale-105 transition-transform duration-300'
          >
            Contact Us
          </button>
        </div>
